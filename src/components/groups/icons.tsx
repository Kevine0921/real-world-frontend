...
export function Plus(props: ComponentProps<"svg">) {
  return (
    <svg aria-label="Plus" aria-hidden="false" viewBox="0 0 16 16" {...props}>
      <path
        fill="white"
...
export function Eye(props: ComponentProps<"svg">) {
  return (
    <svg aria-label="Eye" aria-hidden="false" viewBox="0 0 24 24" {...props}>
      <path
        fill="white"
...
export function Search(props: ComponentProps<"svg">) {
  return (
    <svg aria-label="Search" aria-hidden="false" viewBox="0 0 24 24" {...props}>
      <path
        fill="green"
