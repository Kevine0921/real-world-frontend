                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                ...
                                className="bg-white border-2 placeholder:text-gray-600"
                  ...
                  <div className="flex justify-between text-white">
                    <DialogClose>
                      <Button
                        variant={"outline"}
                        type="button"
                        className="bg-transparent border-orange-500 text-orange-500"
                      >
                        Cancel
                      </Button>
                    </DialogClose>
