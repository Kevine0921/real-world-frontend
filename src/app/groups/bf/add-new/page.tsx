...
function BereavementFundPage({}: Props) {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col items-center   px-6 overflow-auto">
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border disabled:cursor-not-allowed ${
              errors.accountInfo ? "border-red-500" : "border-gray-300"
            } rounded-md focus:border-blue-800 focus:ring focus:ring-blue-200`}
            // value={}
            placeholder={
              accountType === "wallet"
